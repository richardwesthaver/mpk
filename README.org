...
* Overview
=mpk= is a /Media Programming Kit/. It provides a development kit for
digital media.

This project is quite young and will only deal with audio for quite
some time since that's the medium I'm most interested in.

The =mpk= APIs and programs are primarily written in Rust but there is
a number of other langs involved including Python, Scheme, and Elisp.
...
* Dependencies
The following dependencies are required to use =mpk=:
- Emacs
  - lilypond-mode
  - emms
- Rust
